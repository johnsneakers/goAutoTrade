...
// on failure.
func SendHTTPsGetRequest(url string, jsonDecode, isVerbose bool, result interface{}) error {
	if isVerbose {
	...
	if res.StatusCode != 200 {
		return fmt.Errorf("common.SendHTTPsGetRequest() error: HTTP status code %d", res.StatusCode)
	}
